...
export function PositionEditor({ position }: { position: EventPositionDoc }) {
    const groups = useQuery(api.requirements.getRequirementsByPosition, { positionId: position._id });
                    ...
                    <div
                        ...
                        {requirementGroup.requirements.map((requirement, j) => (
                            <div
                                ...
                                <form.AppField name={`requirementGroups[${i}].requirements[${j}].allowedValueIds`}>
                                    {(field) => (
                                        <field.ComboboxField
                                            multiple
