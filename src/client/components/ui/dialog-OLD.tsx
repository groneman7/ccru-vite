...
export function Dialog_OLD({
  ...props
}: ComponentProps<typeof DialogPrimitive.Root>) {
  return <DialogPrimitive.Root data-slot="dialog" {...props} />;
}

export function DialogTrigger_OLD({
  ...props
}: ComponentProps<typeof DialogPrimitive.Trigger>) {
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...props} />;
}

export function DialogPortal_OLD({
  ...props
}: ComponentProps<typeof DialogPrimitive.Portal>) {
  return <DialogPrimitive.Portal data-slot="dialog-portal" {...props} />;
}

export function DialogClose_OLD({
  ...props
}: ComponentProps<typeof DialogPrimitive.Close>) {
  return <DialogPrimitive.Close data-slot="dialog-close" {...props} />;
}

export function DialogOverlay_OLD({
  className,
  ...props
...
export const DialogContent_OLD = forwardRef<
  HTMLDivElement,
  ComponentProps<typeof DialogPrimitive.Content> & {
    showClose?: boolean;
  }
>(function DialogContent({ className, children, showClose, ...props }, ref) {
  return (
    <DialogPortal_OLD data-slot="dialog-portal">
      <DialogOverlay_OLD />
...
DialogContent_OLD.displayName = "DialogContent";

export function DialogHeader_OLD({
  className,
  ...props
}: ComponentProps<"div">) {
  return (
...
export function DialogFooter_OLD({
  className,
  ...props
}: ComponentProps<"div">) {
  return (
...
export function DialogTitle_OLD({
  className,
  ...props
...
export function DialogDescription_OLD({
  className,
  ...props
