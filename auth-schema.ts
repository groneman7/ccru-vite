...
export const user = pgTable("user", {
  ...
  image: text("image"),
  timestampCreatedAt: timestamp("timestamp_created_at").defaultNow().notNull(),
  timestampUpdatedAt: timestamp("timestamp_updated_at")
    .defaultNow()
  ...
  nameMiddle: text("name_middle").notNull(),
