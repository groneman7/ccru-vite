import { pgTable, pgSchema, foreignKey, unique, text, timestamp, integer, index, varchar, boolean } from "drizzle-orm/pg-core"
...
export const users = pgTable("users", {
	...
	timestampFirstLogin: timestamp("timestamp_first_login", { withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
